...
Capabilities: `PARTNER_ONBOARDING_STORE_PUBLICATION`, `CENTRAL_CATALOG`, `CAPTAIN_DISPATCH`, `ORDER_PAYMENT_COLLECTION`, `BENEFICIARY_EARNINGS_SETTLEMENT`, `COMMERCE_PROMOTIONS`, `DISCOVERY_CONTENT`.
