...
→ PHONE-VERIFIED INITIAL ACTIVATION + USER-VERIFIED DISCOVERABLE WEBAUTHN REGISTRATION
→ OPERATOR SESSION
→ STEP-UP ONLY WHEN THE OWNING CAPABILITY REQUIRES IT
→ OPERATOR BREAK-GLASS: ONE-TIME RECOVERY CREDENTIAL + FRESH PHONE PROOF → BOUNDED WEBAUTHN RE-ENROLLMENT → ROTATED RECOVERY CREDENTIAL
```
